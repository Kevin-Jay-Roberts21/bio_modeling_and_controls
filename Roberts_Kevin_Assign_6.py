...
print("metal, which makes sense. This caused dT to be a little smaller.")
print()
...
print()
print("The insulated boundary condition and convection boundary condition simulations")
print("didn't decrease to 40 or 38. To show this, I printed out the final temp of each below:")
print()
print("Convection at final time:")
print(u_convection[n-1,:])
print("Insulation at final time:")
print(u_insulation[n-1,:])
print()
print("We could increase the time (longer than 75 iterations) to see this.")
print("I expect the convection boundary condition siutation to decrease faster.")
